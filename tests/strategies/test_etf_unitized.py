...
class TestETFUnitizedMath:
    ...
    def test_units_times_price_equals_value(self):
        ...
        assert 0.85 * expected_final <= final_value <= 1.15 * expected_final, \
    ...
    def test_splits_dont_change_value(self):
        ...
        etf = ABrick(
            ...
            spec={
                ...
                "splits": [
                    {"month": 6, "ratio": 2.0}  # 2:1 split in month 6
                ],
                "sell_on_window_end": False
            }
        )
        ...
        assert abs(value_after_split - value_before_split) < 1e-6, \
    ...
    def test_sell_on_window_end_generates_cash_flow(self):
        ...
        assert abs(final_cash_out - final_asset_value) < 1e-6, \
    ...
    def test_different_initial_units_produce_proportional_values(self):
        ...
        assert abs(ratio_values - ratio_units) < 0.01, \
...
class TestETFScenarioIntegration:
    ...
    def test_etf_in_diversified_portfolio(self):
        ...
        assert np.all(total_assets >= etf_value), "Total assets should include ETF value"
    ...
    def test_etf_validation_passes(self):
        ...
        scenario = Scenario(
            id="etf_validation_test",
            name="ETF Validation Test",
            bricks=[cash, etf]
        )
