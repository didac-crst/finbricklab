...
from finbricklab.core.currency import create_amount, EUR
from finbricklab.core.accounts import Account, AccountScope, AccountType, AccountRegistry
...
class TestTBrickJournal:
    ...
    def test_compiler_tbrick_compilation(self):
        ...
        account_registry.register_account(Account("savings", "Savings", AccountScope.INTERNAL, AccountType.ASSET))
        account_registry.register_account(Account("checking", "Checking", AccountScope.INTERNAL, AccountType.ASSET))
    ...
    def test_compiler_tbrick_with_fees(self):
        ...
        account_registry.register_account(Account("savings", "Savings", AccountScope.INTERNAL, AccountType.ASSET))
        account_registry.register_account(Account("checking", "Checking", AccountScope.INTERNAL, AccountType.ASSET))
        account_registry.register_account(Account("Expenses:BankFees", "Bank Fees", AccountScope.BOUNDARY, AccountType.EXPENSE))
    ...
    def test_account_scope_validation(self):
        ...
        account_registry.register_account(Account("Income:Salary", "Salary", AccountScope.BOUNDARY, AccountType.INCOME))
